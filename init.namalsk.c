...
class CustomMission: JcaspesMision
{
	...
	override void StartingEquipSetup( PlayerBase player, bool clothesChosen )
	{
		...
		if ( itemClothing )
		{
			...
			SetRandomHealth( itemEnt );
			itemEnt = itemClothing.GetInventory().CreateInInventory("VitaminBottle");
			SetRandomHealth( itemEnt );
			itemEnt = itemClothing.GetInventory().CreateInInventory("TetracyclineAntibiotics");
			SetRandomHealth( itemEnt );
